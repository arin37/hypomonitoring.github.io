    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-toggler-right navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <!-- <a class="nav-link navItem" href="login.php">Home</a> -->
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6">
            <form class="loginForm" method="post" action="forgot-2.php">
              <?php include('errors.php'); ?>
                <input class="registrationInput" type="password" placeholder="Password" name="password"><br>
                <input class="registrationInput" type="password" placeholder="Confirm Password" name="confirm"><br>
                <button class="registrationButton" type="Submit-2" name="Submit-2">Submit</button>
              </form>
        </div>
        <div class="col-lg-3"></div>
    </div>
