...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-6">
            <form class="loginForm" method="post" action="forgot-1.php">
              <?php include('errors.php'); ?>
                <input class="registrationInput" type="email" placeholder="Enter Your Email" name="email"><br>
                <button class="registrationButton" type="submit" name="Submit">Submit</button>
              </form>
        </div>
        <div class="col-lg-3"></div>
    </div>
