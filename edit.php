...
<body>
    <nav class="navbar fixed-top navbar-dark bg-dark navbar-expand-md navHeight">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Hypoglycemia</a>
    ...
    <footer class="container-fluid footer text-center">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 justify mt-auto mb-auto">
                <h4>Adress</h4>
                <h6>Est voluptate culpa cupidatat officia.</h6>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 justify mt-auto mb-auto">
                <a class="foterAncor" href="Contact.php">Contact</a><br>
                <a class="foterAncor" href="about.php">About</a>
            </div>
        </div>
    </footer>
